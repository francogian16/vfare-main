...
class AlpsBus extends StatefulWidget {
  String busID;
  String date;
  String time;

  AlpsBus({required this.busID, required this.date, required this.time});
  @override
  _AlpsBus createState() => _AlpsBus();
}

class _AlpsBus extends State<AlpsBus> {
  int count = 1;
  int index = 0;
  List listLetter = [
    'A',
