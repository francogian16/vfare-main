...
class RrcgBus extends StatefulWidget {
  String busID;
  String date;
  String time;

  RrcgBus({required this.busID, required this.date, required this.time});

  @override
  _RrcgBus createState() => _RrcgBus();
}

class _RrcgBus extends State<RrcgBus> {
  int count = 1;
  int index = 0;
  List listLetter = [
    'A',
